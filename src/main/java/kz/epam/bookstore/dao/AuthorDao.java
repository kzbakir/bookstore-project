...
public class AuthorDao implements BaseDao<Author> {
    ...
    private final String GET_BY_ID_QUERY = "SELECT id,first_name , last_name FROM Author WHERE ID=?;";
    ...
    @Override
    public Author getById(int id) throws SQLException, ConnectionPoolException {
    ...
    @Override
    public List<Author> getAll() throws SQLException, ConnectionPoolException { ;
    ...
    @Override
    public void update(Author author) throws SQLException, ConnectionPoolException {
        connectionPool = ConnectionPool.getInstance();
        connection = connectionPool.takeConnection();
